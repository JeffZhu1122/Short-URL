    ...
    <div class="container">
      ...
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
		  ...
		  <li><a href="./ban.php"><span class="glyphicon glyphicon-home"></span> 黑白名单</a></li>
		  <li><a href="./report.php"><span class="glyphicon glyphicon-home"></span> 生成记录</a></li>

		  <li><a href="./host.php"><span class="glyphicon glyphicon-home"></span> 接口域名</a></li>

		  <?php if($is_fenzhan==0)echo '<li><a href="./sitelist.php"><span class="glyphicon glyphicon-tasks"></span> 分站设置</a></li>';?>
		  <li><a href="../"><span class="glyphicon glyphicon-home"></span> 切换模板</a></li>
...
echo '<form action="./ban.php?my=add_submit" method="POST">
...
if($domain==NULL or $type==NULL){
  ...
  if($DB->query($sql)){
  	showmsg('添加'.($type==2?'黑名单':'白名单').'成功！<br/><br/><a href="./ban.php">>>返回列表</a>',1);
  }else
...
$con.='<a href="./ban.php?my=add" class="btn btn-primary btn-sm">添加记录</a>';
echo $con;
?>
      <div class="table-responsive">
	  <form name="form1" method="post" action="ban.php?my=del2">
...
{
echo '<tr><td><input type="checkbox" name="checkbox[]" value="'.$res['id'].'"> '.htmlspecialchars($res['domain']).'</td><td>'.($res['type']==2?'<font color="black">黑名单</font>':'<font color="orange">白名单</font>').'</td><td>'.$res['date'].'</td><td><a href="./ban.php?my=del&id='.$res['id'].'" class="btn btn-xs btn-danger" onclick="return confirm(\'你确实要删除此记录吗？\');">删除</a></td></tr>';
}
?>
          </tbody>
        </table>
